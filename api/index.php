...
<head>
    <title>Cronos</title>
    <link rel="stylesheet" href="/Cronos2/index.css">
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="icon" type="image/x-icon" href="/Cronos2/imagenes/LogoRelojeria.png">
    ...
    <link rel="stylesheet" href="/Cronos2/carrito.css">
    <script src="/Cronos2/carrito.js" async></script>
</head>
<body>
    <div class="barra"> 
        <h2>Menu<img src="/Cronos2/imagenes/menu.png" alt="Menu" style="width: 40px; cursor: pointer;"></h2>
        <ul>
    ...
    <header style="display: flex; align-items: center; justify-content: space-between; padding: 10px;">
        ...
        <div class="search-container" style="display: flex; align-items: center; margin-left: 70px;">
            <img src="/Cronos2/imagenes/buscar.png" alt="Buscar.icon" style="width: 50px; cursor: pointer;">
            <input type="text" placeholder="Buscar" id="buscar" class="search-bar">
        </div>
        
        <div style="display:flex; align-items: center; margin-left: -150px;">
            <img src="/Cronos2/imagenes/LogoRelojeria.png" alt="Logo" style="width: 100px; height: 100px; margin-left: 200px;">
            <h2 style="color:aliceblue">CRONOS</h2>
        </div>
        <div style="display: flex; align-items: center;"> 
            <a href="login.php">
                <img src="/Cronos2/imagenes/usuario.png" id="icono_user" alt="User Icon" style="width: 40px; height: 40px; cursor: pointer;">
            </a>
        </div>
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" data-bs-interval="7000" data-bs-pause="false">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="/Cronos2/imagenes/reloj_para_hombre.jpg" class="d-block w-100" alt="Imagen 1">
                ...
                <div class="carousel-item">
                    <img src="/Cronos2/imagenes/reloj_para_mujer.png" class="d-block w-100" alt="Imagen 2">
                    <div class="carousel-caption d-none d-md-block">
    ...
    <div class="container">
        ...
        <div class="container-products">
            <div class="card-product" >
                <div class="container-img">
                    <div class="flip-container">
                        <img src="/Cronos2/imagenes/reloj_1.jpg" alt="Imagen Producto" class="img-item"/>
                        <div class="face-back">
                            <ul>
            ...
            <div class="card-product" >
                <div class="container-img">
                    <div class="flip-container">
                        <img src="/Cronos2/imagenes/reloj-dama-1.png" alt="Imagen Producto" class="img-item"/>
                        <div class="face-back">
                            <ul>
            ...
            <div class="card-product">
                <div class="container-img">
                    <div class="flip-container">
                        <img src="/Cronos2/imagenes/reloj_3.jpeg" alt="Imagen Producto" class="img-item"/>
                        <div class="face-back">
                            <ul>
            ...
            <div class="card-product">
                <div class="container-img">
                    <div class="flip-container">
                        <img src="/Cronos2/imagenes/reloj-dama-2.jpg" alt="Imagen Producto" class="img-item"/>
                        <div class="face-back">
                            <ul>
            ...
            <div class="card-product">
                <div class="container-img">
                    <div class="flip-container">
                        <img src="/Cronos2/imagenes/reloj_2.jpg" alt="Imagen Producto" class="img-item"/>
                        <div class="face-back">
                            <ul>
            ...
            <div class="card-product">
                <div class="container-img">
                    <div class="flip-container">
                        <img src="/Cronos2/imagenes/reloj-dama-3.jpg" alt="Imagen Producto" class="img-item"/>
                        <div class="face-back">
                            <ul>
            ...
            <div class="card-product">
                <div class="container-img">
                    <div class="flip-container">
                        <img src="/Cronos2/imagenes/reloj_7.jpg" alt="Imagen Producto" class="img-item"/>
                        <div class="face-back">
                            <ul>
            ...
            <div class="card-product">
                <div class="container-img">
                    <div class="flip-container">
                        <img src="/Cronos2/imagenes/reloj-dama-4.jpeg" alt="Imagen Producto" class="img-item"/>
                        <div class="face-back">
                            <ul>
            ...
            <div class="card-product">
                <div class="container-img">
                    <div class="flip-container">
                        <img src="/Cronos2/imagenes/reloj_9.jpg" alt="Imagen Producto" class="img-item"/>
                        <div class="face-back">
                            <ul>
    ...
    <footer>
        <div class="footer-content">
            ...
            <div class="social-media">
                ...
                <a href="#">Twitter</a>
                <a href="#">Correo</a>
                <div class="/Cronos2/imagen_redessociales">
                    <img src="/Cronos2/imagenes/redes_sociales.png" alt="imagen ilustrativa">
                </div>
            </div>
    ...
    <script src="/Cronos2/accesorios.js"></script>
</body>
</html>
